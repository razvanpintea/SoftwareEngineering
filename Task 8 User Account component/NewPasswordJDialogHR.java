...
public class NewPasswordJDialogHR extends JDialog {//the GUI for changing the Human Resources password
	...
	public static void main(String[] args) {
		try {
			NewPasswordJDialogHR dialog = new NewPasswordJDialogHR();
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						{
							ProjectDatabase.updateInspectPassword(pass,"hr"); //the password of the Human Resources user is updated
							dispose();
