...
public class NewPasswordJDialogAdmin extends JDialog {//the GUI for changing the admins password
	...
	public static void main(String[] args) {
		try {
			NewPasswordJDialogAdmin dialog = new NewPasswordJDialogAdmin();
	 ...
	 * Create the dialog.
	 */
	public NewPasswordJDialogAdmin() {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						{
							ProjectDatabase.updateInspectPassword(pass,"admin"); //the password of the admin user is updated
							dispose();
